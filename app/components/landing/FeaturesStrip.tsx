import { MdViewQuilt, MdAutoAwesome, MdVaccines, MdForum, MdPayments, MdQueryStats } from "react-icons/md";
    ...
    <section id="features" className="py-24 px-margin-mobile md:px-margin-desktop bg-surface max-w-container-max mx-auto rounded-[2rem] my-12 border border-outline-variant/30">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-surface-container-lowest border border-outline-variant rounded-xl p-8 ambient-shadow hover:-translate-y-1 transition-transform duration-300">
          <MdViewQuilt className="text-primary mb-6 text-3xl" />
        ...
        {/* Card 2 */}
        <div className="bg-surface-container-lowest border border-outline-variant rounded-xl p-8 ambient-shadow hover:-translate-y-1 transition-transform duration-300">
          <MdAutoAwesome className="text-secondary mb-6 text-3xl" />
        ...
        {/* Card 3 */}
        <div className="bg-surface-container-lowest border border-outline-variant rounded-xl p-8 ambient-shadow hover:-translate-y-1 transition-transform duration-300">
          <MdVaccines className="text-tertiary-container mb-6 text-3xl" />
        ...
        {/* Card 4 */}
        <div className="bg-surface-container-lowest border border-outline-variant rounded-xl p-8 ambient-shadow hover:-translate-y-1 transition-transform duration-300">
          <MdForum className="text-primary mb-6 text-3xl" />
        ...
        {/* Card 5 */}
        <div className="bg-surface-container-lowest border border-outline-variant rounded-xl p-8 ambient-shadow hover:-translate-y-1 transition-transform duration-300">
          <MdPayments className="text-primary mb-6 text-3xl" />
        ...
        {/* Card 6 */}
        <div className="bg-surface-container-lowest border border-outline-variant rounded-xl p-8 ambient-shadow hover:-translate-y-1 transition-transform duration-300">
          <MdQueryStats className="text-primary mb-6 text-3xl" />
